...
sections:
  ...
  - block: experience
    content:
      ...
      items:
        - title: Студентка факультета физико-математических и естественных наук
          company: RUDN
    ...
    content:
      ...
      items:
        ...
        - certificate_url:
          ...
          description: 'Сертификат не выдаётся'
          icon: stepic
          organization: Stepic
          organization_url: https://stepik.org/learn
          title: Организация администрирования компьютерных сетей
          url: ''
    design:
      columns: '2'
  - block: collection
